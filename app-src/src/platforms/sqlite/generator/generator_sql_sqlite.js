import { DefaultGeneratorOptionsSQLite } from "../../../generator/model-to-sql-model/generator_options";
...
export const generateSQL = (sqlSettings, modelToSQLModel) => {
...
export const generateCreateIndexSQL = (sqlSettings, model, table, index) => {
