...
import { fetchTable, fetchTableAndCatalog } from "../../actions/tables";
import { finishTransaction, startTransaction } from "../../actions/undoredo";
import { setForcedRender, updateUiProperty } from "../../actions/ui";
...
class ColumnsMongoDb extends Component {
  renderDataTypesMongoDb(fn, colDatatype) {
    return (
      <select value={colDatatype} onChange={fn}>
        {MongoDbHelpers.makeDatatypesHierarchy(colDatatype, this.props.tables)}
  ...
  navigateToTabChildren(table, col) {
    this.props.updateUiProperty(1, "activeColumnDetailTab");
      ...
      return (
        <div key={col.id}>
          <div className={"dRowForm dRowForm" + this.props.type}>
            ...
            />
            {this.renderDataTypesMongoDb(
              this.props.handleChangeDatatypeMongo.bind(this, col.id),
              col.datatype
            )}
            ...
            {col.fk ? (
              ...
              <div
                ...
                onClick={this.props.deleteColComplex.bind(this, col.id)}
              >
            ...
            >
              ...
              >
                ...
                <CheckboxSwitch
                  label="Pattern"
                  checked={Helpers.gch(col.pattern)}
                  onChange={this.props.handleCheckboxChange.bind(
                    this,
                    col.id,
                    "pattern"
                ...
                {this.props.tables[col.datatype] ? (
                  <>
                    <div />
                    <div className="im-content-spacer-sm" />
                    <div />
                    <div>
                      <div
                        className="im-btn-link im-pointer"
                        onClick={this.navigateToTabChildren.bind(
                          this,
                          table,
                          col
                        )}
                      >
                        Edit children / object items
                      </div>
                    </div>
                  </>
                ) : (
  ...
  render() {
    return (
      <div className="im-items-grid">
        {this.renderColumnsCaption(this.props.tables[this.props.passedTableId])}
        <Sortable
          options={{
            handle: ".handle",
            animation: 150,
          ...
          onChange={async (order, sortable, evt) => {
            ...
            await this.props.startTransaction(
              ...
              UndoRedoDef.COLUMNS_MONGODB__COLS_REORDER
            );
            try {
              ...
              await this.props.fetchTableAndCatalog(
                this.props.tables[this.props.passedTableId]
              );
            } finally {
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(ColumnsMongoDb)
);
