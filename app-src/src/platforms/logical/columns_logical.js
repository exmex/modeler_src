...
class ColumnsLogical extends Component {
  renderDataTypesLogical(fn, colDatatype) {
    return (
        ...
        <Sortable
          ...
          onChange={async (order, sortable, evt) => {
            ...
            await this.props.startTransaction(
              ...
              UndoRedoDef.COLUMNS_LOGICAL__COLS_REORDER
            );
            try {
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(ColumnsLogical)
);
