...
class ColumnsMSSQL extends Component {
  renderDataTypesMSSQL(fn, colDatatype) {
    return (
              ...
              >
                ...
                <div className="im-grid-right-icon">
                  <DebounceInput
                    ...
                    value={Helpers.gv(col.mssql?.computed)}
        ...
        <Sortable
          ...
          onChange={async (order, sortable, evt) => {
            ...
            await this.props.startTransaction(
              ...
              UndoRedoDef.COLUMNS_MSSQL__COLS_REORDER
            );
            try {
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(ColumnsMSSQL)
);
