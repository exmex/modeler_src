  ...
  renderDataTypesMongoose(fn, colDatatype) {
    return (
      <select value={colDatatype} onChange={fn}>
        {MongooseHelpers.makeDatatypesHierarchy(colDatatype, this.props.tables)}
        ...
        <div key={col.id}>
          <div className={"dRowForm dRowForm" + this.props.type}>
            ...
            {this.renderDataTypesMongoose(
              this.props.handleChangeDatatypeMongoose.bind(this, col.id),
              col.datatype
            )}
            ...
            >
              ...
              >
                ...
                this.props.tables[col.datatype].name === "Object" ? (
                  <>
                    <div />
