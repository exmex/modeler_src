...
class NoteGraphics extends Component {
  async handleTextColorChange(obj) {
    await this.props.startTransaction(
      getHistoryContext(this.props.history, this.props.match),
      UndoRedoDef.NOTE_GRAPHICS__UPDATE_DIAGRAM_ITEM_PROPERTY_COLOR
    );
    try {
  ...
  async handleBackgroundChange(obj) {
    await this.props.startTransaction(
      getHistoryContext(this.props.history, this.props.match),
      UndoRedoDef.NOTE_GRAPHICS__UPDATE_DIAGRAM_ITEM_PROPERTY_BACKGROUND
    );
    try {
      await this.props.updateDiagramItemProperty(
        this.props.match.params.did,
  ...
  async switchLockDimensions(event) {
    ...
    await this.props.startTransaction(
      getHistoryContext(this.props.history, this.props.match),
      UndoRedoDef.NOTE_GRAPHICS__SWITCH_LOCK_DIMENSIONS
    );
    try {
        ...
        <div className="im-properties-grid">
          ...
          <div className="im-color-picker">
            <ColorPickerPanel
              ...
              enableAlpha={false}
              color={this.activeNote().background}
          ...
          <CheckboxSwitch
            ...
            checked={this.activeNote().resized}
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(NoteGraphics)
);
