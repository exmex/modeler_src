            ...
            <TabPanel className="tabDetails im-tab-panel">
              <div className="im-connections-grid">
                ...
                <CheckboxSwitch
                  ...
                  onChange={this.handleCheckChange.bind(this, "retryWrites")}
                />
              </div>
            </TabPanel>
            <TabPanel className="tabDetails im-tab-panel">
    ...
    return (
      <div className="im-connections-grid">
        {isFeatureAvailable(availableFeatures, Features.TLS) ? (
          <>
            ...
            <CheckboxSwitch
              label={`Encrypt`}
              checked={
                this.props.connections[this.props.activeConnection].encrypt
              }
              onChange={this.handleCheckChange.bind(this, "encrypt")}
            />
          </>
        ) : (
          <></>
        ...
        <CheckboxSwitch
          ...
          onChange={this.handleCheckChange.bind(this, "trustServerCertificate")}
        />
      </div>
    );
  }
