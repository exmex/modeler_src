...
import { isGalaxy, isLuna, isMeteor, isMoon, isPerseid } from "../../helpers/features/features";
...
import CarouselTipsGalaxy from "../../components/carousel_tips_galaxy";
import CarouselTipsLuna from "../../components/carousel_tips_luna";
              ...
              >
                ...
                <div className="modal-content">
                  <div>
                    ...
                    {isLuna(this.props.profile) && <CarouselTipsLuna />}
                    {isGalaxy(this.props.profile) && <CarouselTipsGalaxy />}
                  </div>
                </div>
