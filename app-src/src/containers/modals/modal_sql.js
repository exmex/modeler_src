...
import { generateMSSQLModelSQL } from "../../platforms/mssql/generator/generator_sql_mssql";
...
class ModalSql extends Component {
  ...
  renderScriptTab() {
    if (this.props.type === "SEQUELIZE") {
      ...
      return <StatementsModelDiagram getScript={generateMSSQLModelSQL} />;
  ...
  renderDiagramScriptTab() {
    if (this.props.type === ModelTypes.SEQUELIZE) {
      ...
      return (
        <StatementsModelDiagram
          getScript={generateMSSQLModelSQL}
          onlyActiveDiagram
        />
      );
    } else if (JsonSchemaHelpers.isPerseidModelType(this.props.type)) {
