...
import { generateRelationSQL as generateMSSQLRelationSQL } from "../../platforms/mssql/generator/generator_sql_mssql";
...
class ModalRelation extends Component {
  ...
  renderScript() {
    return (
      <>
        ...
        {this.renderRelationStatementsMSSQL()}
      </>
    );
  }
  ...
  renderRelationStatementsMSSQL() {
    return this.props.type === ModelTypes.MSSQL ? (
      <RelationStatements generateRelationSQL={generateMSSQLRelationSQL} />
    ) : (
      <></>
    );
  }
