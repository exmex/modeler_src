...
class ModelDropDown extends Component {
  ...
  renderNewObjectsMenu() {
    ...
    if (this.props.type === "MSSQL") {
      return this.renderNewObjectsMenuMSSQL();
    }
        ...
        <>
          ...
          >
            <>
              ...
              <ContextMenuItem
                fn={() =>
                  this.onAddOtherObjectClick(OtherObjectTypes.UserDefinedType)
                }
                caption={_.upperFirst(
                  this.props.localization.L_USER_DEFINED_TYPE
                )}
              />
              <ContextMenuItem
                fn={() => this.onAddOtherObjectClick(OtherObjectTypes.Other)}
      ...
      return (
        ...
        >
          <>
            ...
            {!isMainDiagram ? this.renderAddReferenced() : <></>}
