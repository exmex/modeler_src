...
import ModelAuthor from "./model_author";
...
import ModelDefaultValuesMSSQL from "../platforms/mssql/model_default_values_mssql";
          ...
          <div className="im-tabs-area">
            ...
            {!JsonSchemaHelpers.isPerseidModelType(this.props.type) && (
              <TabPanel className="im-aside">
                <CollapsiblePanel
                  panelTitle="Author"
                  panelKey="pModelAuthor"
                  panelIsExpanded={this.props.panelsExpanded.pModelAuthor}
                >
                  <div className="im-collapsible-panel">
                    <ModelAuthor />
                  </div>
