        ...
        <div className="im-properties-grid">
          ...
          <div className="im-grid-right-icon">
            <DebounceInput
              ...
              data-testid={TEST_ID.DETAIL.PG_SCHEMA}
              onChange={this.handleTextChangePlatform.bind(
                this,
                "schema",
                "pg"
      ...
      <div className="im-properties-grid">
        ...
        <div className="im-grid-right-icon">
          <DebounceInput
            ...
            type="text"
            value={Helpers.gv(
              this.props.tables[this.props.match.params.id].mssql &&
                this.props.tables[this.props.match.params.id].mssql.schema
            )}
            data-testid={TEST_ID.DETAIL.MSSQL_SCHEMA}
            onChange={this.handleTextChangePlatform.bind(
              this,
              "schema",
              "mssql"
    ...
    return (
      <div className="im-properties-grid">
        ...
        <CheckboxSwitch
          ...
          checked={
            this.props.tables[this.props.match.params.id].sqlite &&
            this.props.tables[this.props.match.params.id].sqlite.strict
          }
          onChange={this.handleCheckboxChangePlatform.bind(
            this,
            "strict",
