...
import IndexMSSQL from "../platforms/mssql/index_mssql";
...
class Indexes extends Component {
  ...
  initColumnRefMSSQL() {
    return this.props.type === ModelTypes.MSSQL ? { mssql: {} } : {};
  }
  ...
  initMSSQLIndex() {
    return this.props.type === ModelTypes.MSSQL
      ? { mssql: { type: "RELATIONAL", clustered: true } }
      : {};
  }
  ...
  renderIndexCaptionsMSSQL() {
    return (
      <div className="im-index-detail-grid-mssql im-cols-header-fixed">
        <div className="im-bold">
          {_.upperFirst(this.props.localization.L_COLUMNS)}:
        </div>
        <div>Column</div>
  ...
  renderIndexColumnItemMSSQL(index, indexcol) {
    return (
      <div key={indexcol.id} className="im-mt-mini">
        <div className="im-index-detail-grid-mssql ">
          <div />
          <select
            value={indexcol.colid}
            onChange={this.handleColumnInIndexChange.bind(
          ...
          <CheckboxCustom
            checked={Helpers.gch(indexcol.mssql && indexcol.mssql.desc)}
            label=""
            onChange={this.handleIndexColChangePlatform.bind(
              this,
              index.id,
  ...
  getIndexColumnsMSSQL(index) {
    return index.cols.length > 0 ? (
      <>
        {this.renderIndexCaptionsMSSQL()}
        {index.cols.map((indexcol) =>
          this.renderIndexColumnItemMSSQL(index, indexcol)
        )}
      </>
    ) : (
      ``
  ...
  getIndexExtendedPropertiesMSSQL(index) {
    return (
      <IndexMSSQL
        handleTextChangePlatform={this.handleTextChangePlatform}
        handleCheckboxChange={this.handleCheckboxChange}
        handleCheckboxChangePlatform={this.handleCheckboxChangePlatform}
        index={index}
      />
    );
  }
  ...
  getIndexesClass() {
    if (
      ...
      return "im-keys-grid-pg";
    } else if (this.props.type === ModelTypes.MSSQL) {
      return "im-keys-grid-mssql";
    } else {
      return "im-keys-grid";
    }
  }
            ...
            <DetailPanel colspan="4">
              ...
              >
                {this.props.type === ModelTypes.PG
                  ...
                  : this.props.type === ModelTypes.MSSQL
                  ? this.getIndexColumnsMSSQL(index)
                  : this.props.type === ModelTypes.SQLITE
              ...
              this.props.type === ModelTypes.MYSQL ? (
                ...
                this.getIndexExtendedPropertiesMSSQL(index)
              ) : this.props.type === ModelTypes.SQLITE ? (
