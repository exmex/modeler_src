...
import PrintBackground from "../assets/ui-print.png";
        ...
        <div className="im-full-page-wrapper">
          ...
          <div className="im-align-center im-padding-md">
            ...
            <div className="im-custom-select-wrapper">
              ...
              <div
                className="im-custom-select-center im-pointer"
              ...
              <div
                ...
                onClick={this.handleThemeChangeCustom.bind(this, "im-print")}
              >
                <img
                  alt={
                    this.props.settings.theme
                  ...
                  className={
                    this.props.settings.theme === "im-print"
                      ? "im-custom-select-selected"
                      : ""
                  }
                  src={PrintBackground}
            ...
            <div className="im-row-form">
              ...
              <div className="im-cell">
                ...
                >
                  ...
                  <option value="im-print">Print</option>
                </select>
              </div>
            </div>
