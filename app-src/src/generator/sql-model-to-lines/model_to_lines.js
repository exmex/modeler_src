...
export const QUOTATION_TYPE_DOUBLE_QUOTES = "double_quotes";
export const QUOTATION_TYPE_SQUARE_BRACKETS = "square_brackets";
...
export const DefaultSqlSettingsMSSQL = {
  ...DefaultSqlSettings,
  statementDelimiter: GO,
  includeGeneratedNames: INCLUDE_GENERATED_NAMES_ALWAYS,
  quotationType: QUOTATION_TYPE_SQUARE_BRACKETS
};
