...
class AddButtonsMongoose extends Component {
  ...
  render() {
    const isMongoose = this.props.type === ModelTypes.MONGOOSE;
    return (
      isMongoose && (
        <>
...
export default connect(mapStateToProps)(AddButtonsMongoose);
