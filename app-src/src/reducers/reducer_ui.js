...
const diffHTMLReportModalIsDisplayed = false;
const reverseStatsIsDisplayed = false;
...
export default function (
  state = {
    ...
    diffHTMLReportModalIsDisplayed,
  ...
  switch (action.type) {
    ...
    case TOGGLE_DIFF_HTML_REPORT_MODAL:
      return {
        ...state,
        diffHTMLReportModalIsDisplayed: !state.diffHTMLReportModalIsDisplayed
      };
    case TOGGLE_REVERSE_STATS_MODAL: {
      return {
        ...state,
        reverseStatsIsDisplayed: !state.reverseStatsIsDisplayed
      };
    }
    ...
    case CLEAR_BACKUP_MODEL_DIALOG: {
      return _.omit(state, "backupModelDialog");
    }

    case SET_BACKUP_MODEL_DIALOG: {
      return { ...state, backupModelDialog: action.payload };
    }
