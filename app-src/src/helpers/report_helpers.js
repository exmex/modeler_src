...
const ReportHelpers = {
  ...
  getSectionTitle: function (sectionTitle) {
    return `<div class="mm-section-group">${sectionTitle}</div>`;
  },
  ...
  getWatermarkFileNameByProduct(productName) {
    switch (productName) {
      ...
      case "LunadModeler":
        return "./assets/watermark-luna.svg";
      case "GalaxyModeler":
        return "./assets/watermark-galaxy.svg";
      default:
