...
export class ProjectAuthorNameProblem extends Problem {
  getTitle() {
    return "Project Author Name Problem";
  }
...
export class ProjectCompanyDetailsProblem extends Problem {
  getTitle() {
    return "Project Company Details Problem";
  }
...
export class ProjectCompanyUrlProblem extends Problem {
  getTitle() {
    return "Project Company Url Problem";
  }
...
export class ProjectCurrentDisplayModeProblem extends Problem {
  getTitle() {
    return "Project Current Display Mode Problem";
  }
...
export class RelationCardinalityTypeProblem extends Problem {
  ...
  fix(model) {
    try {
      if (!!model.relations[this.relationid]) {
        return {
          ...model,
          relations: {
            ...model.relations,
