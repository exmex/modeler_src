...
const PostgresTestConnectionExecutorBuilder = require("../pg-test-connection-builder");
...
it("should return correct parameters", () => {
  ...
  const builder = new PostgresTestConnectionExecutorBuilder(
    connection,
    filenameProvider,
    payloadProcessor
  );
  ...
  expect(result.parameters.args[1]).toEqual("db");
