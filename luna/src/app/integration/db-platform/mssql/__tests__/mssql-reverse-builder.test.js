...
const MSSQLReverseExecutorBuilder = require("../mssql-reverse-builder");
...
it("should return correct parameters", () => {
  ...
  const builder = new MSSQLReverseExecutorBuilder(
    connection,
    filenameProvider,
    payloadProcessor
  );
  ...
  expect(result.parameters.args[1]).toEqual("server");
  expect(result.parameters.args[2]).toEqual("port");
...
it("should return correct ssh parameters", () => {
  ...
  //then
  expect(result.parameters.args[8]).toEqual("sshEnabled");
  expect(result.parameters.args[9]).toEqual("sshhost");
  expect(result.parameters.args[10]).toEqual("sshport");
  expect(result.parameters.args[11]).toEqual("sshusername");
  expect(result.parameters.args[12]).toEqual("sshpassword");
  expect(result.parameters.args[13]).toEqual("sshprivatekey");
  expect(result.parameters.args[14]).toEqual("sshpassphrase");
  expect(result.parameters.args[15]).toEqual(true);
});
