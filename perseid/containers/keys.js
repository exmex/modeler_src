...
class Keys extends Component {
  ...
  async handleChangeUsing(key_id, event) {
    const value = event.target.value;
    await this.props.startTransaction(
      getHistoryContext(this.props.history, this.props.match),
      UndoRedoDef.KEYS__UPDATE_KEY_PROPERTY_USING
    );
    try {
      await this.props.updateKeyProperty(
        this.props.match.params.id,
    ...
    return (
      <div className="im-mt">
        <div className="im-properties-grid">
          ...
          <select
            value={key.using}
            onChange={this.handleChangeUsing.bind(this, key.id)}
          >
  ...
  getExtendedByModelType(key) {
    if (
      ...
      this.getKeyExtendedProperties(key);
    }
  }
