...
const INIT_STATE = {
  ...
  type: "MONGODB",
  availableTypes: [
    { id: "MONGODB", text: "MongoDB", icon: MongoDBIcon },
    { id: "PG", text: "PostgreSQL", icon: PostgreSQLIcon },
    {
      id: ModelTypes.MARIADB,
      text: ModelTypesForHumans.MARIADB,
      icon: MariaDBIcon
    },
    { id: ModelTypes.MYSQL, text: ModelTypesForHumans.MYSQL, icon: MySQLIcon }
  ],
  server: "",
  port: "",
  user: "",
    ...
    return (
      <>
        ...
        <CheckboxSwitch
          ...
          checked={this.state.parseData}
          onChange={this.handleCheck.bind(this, "parseData")}
        />
        <div hidden={this.state.parseData === false} />
        <CheckboxSwitch
          label={"Parse maximum records (no data limit)"}
          checked={this.state.noLimit}
          onChange={this.handleCheck.bind(this, "noLimit")}
          hidden={this.state.parseData === false}
        />
        <div
          className="im-align-self-center"
          hidden={this.state.noLimit === true || this.state.parseData === false}
        >
          Data limit:
        </div>
        <DebounceInput
                    ...
                    <React.Fragment>
                      <div className="im-connections-grid">
                        ...
                        >
                          ...
                          <option value={ModelTypes.MARIADB}>
                            {ModelTypesForHumans.MARIADB}
                          </option>
                          <option value={ModelTypes.MYSQL}>
                            {ModelTypesForHumans.MYSQL}
                          </option>
