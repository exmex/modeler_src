...
import { handleBackupModelChange } from "../actions/settings";
...
class ElectronMenu extends Component {
  ...
  componentDidMount() {
    ...
    if (isElectron()) {
      ...
      ipcRenderer.on("model:wantToSaveAs", (event, result) => {
        this.props.saveModel(ipcRenderer, true, () => {});
      });
  ...
  componentDidUpdate(prevProps) {
    this.props.handleBackupModelChange(prevProps.settings.backupModelTime);
