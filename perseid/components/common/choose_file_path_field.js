...
function sendChooseFilePathEventReceiver(
  propertyName,
  currentFilePath,
  title,
  filters
...
function registerChooseFilePathEventReceiver(updateProperty) {
...
function chooseFilePath(
  ...
  if (ipcRenderer) {
    registerChooseFilePathEventReceiver(updateProperty);
    sendChooseFilePathEventReceiver(
      propertyName,
      currentFilePath,
      title,
      filters
