...
class ColumnsMySQLFamily extends Component {
        ...
        <Sortable
          ...
          onChange={async (order, sortable, evt) => {
            ...
            await this.props.startTransaction(
              ...
              UndoRedoDef.COLUMNS_MYSQLFAMILY__COLS_REORDER
            );
            try {
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(ColumnsMySQLFamily)
);
