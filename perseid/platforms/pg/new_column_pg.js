...
class NewColumnPG extends Component {
  constructor(props) {
    super(props);
  ...
  renderDataTypes() {
    if (
      ...
      return this.renderDataTypesPG((e) =>
...
export default connect(mapStateToProps)(NewColumnPG);
