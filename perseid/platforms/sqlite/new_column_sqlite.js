...
class NewColumnSQLite extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  renderDataTypes() {
    if (
      ...
      return this.props.renderDataTypesJson((e) =>
        this.props.handleStateChange("valueDatatype", e.target.value)
      );
    } else {
      return this.renderDataTypesSQLite((e) =>
        this.props.handleStateChange("valueDatatype", e.target.value)
      );
    }
  }
...
export default connect(mapStateToProps)(NewColumnSQLite);
